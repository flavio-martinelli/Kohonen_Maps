...
params.maxIter = 20000; % maximum number of iteration
...
params.displayStep = round(params.maxIter/3);

params.computeUdpates = false; % compute updates along training process
